...
import { uploadDocument, getDocuments, signDocument, signDocumentPost, deleteDocument, shareDocument } from '../controllers/documentController';
...
router.post('/sign', protect, signDocumentPost);
